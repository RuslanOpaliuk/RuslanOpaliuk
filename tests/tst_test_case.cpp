...
protected:
    ...
    // uint8_t check_data_3[19] = {0xDD, 0xBB, 0xAA, 0xF3, 0x77, 0x20, 0x56, 0xC4, 0x95, 0x94, 0x76, 0x8B, 0x12, 0x88, 0x34, 0xDD, 0xBB};
...
TEST_F(LL_Protocol, deserializing_check_message_test)
{
    ...
    EXPECT_EQ(error_long_msg, 0UL);
     ...
     message_t deseriazized_msg = messages.dequeue();
}
